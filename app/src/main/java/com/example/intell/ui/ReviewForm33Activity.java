...
//        int top = allLinearLayout[7].getTop();
    ...
    void ButtonPdfWasClicked() {
        ...
        try {
            ...
            filePath = "/Download/" + getResources().getString(R.string.check_form_33_title) + ".pdf";
    ...
    void createPdf() {
        try {
            new AddingTable33(this, checkList, rejectedFlag, reviewNotes).manipulatePdf(dir + filePath);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
