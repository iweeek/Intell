...
public class RichTextEditor extends ScrollView {
	...
	private OnFocusChangeListener myFocusListener; // 所有EditText的焦点监听listener
...
//				System.out.println("onFocusChange 改变啦");
//				myFocusListener.onFocusChange(v, hasFocus);
	...
	public void addEditTextAtIndex(final int index, CharSequence editStr) {
		try {
			EditText editText2 = createEditText(null, EDIT_PADDING);
